...
This feature uses AI to analyze your entire project and generate a comprehensive, domain-specific translation prompt tailored to your document. The generated prompt includes terminology rules, style guidelines, anti-truncation controls, and domain-specific instructions — ready to use with Batch Translate.

## How It Works

### 1. Start the analysis

On the **Batch Operations** tab, click the **Analyze Project & Generate Prompt…** link next to the prompt dropdown.
