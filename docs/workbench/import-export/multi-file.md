...
2. Choose a folder containing supported files (DOCX/TXT)
...
- Use this when you receive a set of small files (e.g., UI strings split across documents).
- Export can be done per-file into a destination folder.
