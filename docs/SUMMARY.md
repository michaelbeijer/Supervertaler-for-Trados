...
* [Supervertaler Assistant](ai-assistant.md)
  ...
  * [SuperMemory](ai-assistant/super-memory.md)
    * [Quick Add](ai-assistant/super-memory/quick-add.md)
    * [Process Inbox](ai-assistant/super-memory/process-inbox.md)
    * [Health Check](ai-assistant/super-memory/health-check.md)
    * [Distill](ai-assistant/super-memory/distill.md)
    * [Active Prompt](ai-assistant/super-memory/active-prompt.md)
    * [AI Integration](ai-assistant/super-memory/ai-integration.md)
    * [Obsidian Setup](ai-assistant/super-memory/obsidian-setup.md)
